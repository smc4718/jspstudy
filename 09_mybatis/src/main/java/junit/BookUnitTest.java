 ...
 *  2) WAS(Tomcat)의 개입이 없으므로 WAS가 필요한 코드는 테스트 불가하다.(정확히는 일반적인 방법으로는 불가능하다는 말:request 나 response 는 안됨)
...
public class BookUnitTest {
  ...
  public void 책_등록_테스트() {
    ...
    //등록 결과 확인/ 기대값은 1, 실제 결과값은 addResult임
